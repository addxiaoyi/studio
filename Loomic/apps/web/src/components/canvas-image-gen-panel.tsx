...
import type { ImageArtifact } from "@helstera/shared";
...
export function CanvasImageGenPanel({
  ...
  return (
    <div className="w-80 rounded-2xl glass shadow-card-hover border border-border/60 p-4">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-medium text-foreground">AI Image</h3>
        <button
          onClick={onClose}
      ...
      <button
        ...
        className="mt-3 w-full rounded-lg bg-foreground text-background py-2 text-sm font-medium transition-all duration-300 disabled:opacity-40 hover:opacity-90"
      >
        {loading ? (
