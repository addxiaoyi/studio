        ...
        {fonts.map((font) => (
          <div key={font.id} className="flex flex-col items-center gap-1.5">
            <div className="relative group">
              <div className="w-[150px] h-[113px] rounded-2xl glass-soft border border-border/40 flex items-center justify-center transition-all duration-300 group-hover:glass">
                <span
              ...
              <button
                ...
                className={cn(
                  "absolute -top-1.5 -right-1.5 h-5 w-5 rounded-full glass-soft border border-border/60",
        ...
        <div className="flex flex-col items-center gap-1.5">
          <div ref={menuRef} className="relative">
            <button
              ...
              className="w-[150px] h-[113px] rounded-xl border-2 border-dashed border-muted-foreground/30 flex items-center justify-center hover:border-foreground/30 hover:bg-foreground/[0.02] transition-all duration-300 cursor-pointer focus-visible:ring-2 focus-visible:ring-foreground/20"
              aria-label="Add font"
            >
            ...
            {menuOpen && (
              <div className="absolute left-0 top-full mt-1 z-50 w-[180px] rounded-xl glass-strong border border-border/40 p-1.5 shadow-card-hover">
                <button
                  type="button"
                  onClick={() => {
                    setMenuOpen(false);
                  ...
                  className="flex w-full items-center rounded-lg px-3 py-2 text-sm text-foreground hover:bg-foreground/[0.04] transition-all duration-300 cursor-pointer"
                >
                  从字体库选择
                </button>
                <button
