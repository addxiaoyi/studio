      ...
      <header className="flex min-h-[64px] shrink-0 flex-wrap items-center justify-between gap-3 border-b px-4 py-3 sm:px-6 md:h-[96px] md:flex-nowrap md:py-0">
        ...
        <div className="flex items-center gap-3 shrink-0 ml-4">
          ...
          >
            <span
              className={cn(
                "inline-block h-4 w-4 rounded-full bg-foreground transition-all duration-300",
  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        ...
        className="rounded-full p-1.5 glass-soft border border-border/40 text-muted-foreground hover:bg-foreground/[0.04] transition-all duration-200 cursor-pointer"
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1.5 z-50 w-[140px] rounded-xl glass-strong border border-border/40 p-1.5 shadow-card-hover">
          <button
            type="button"
            onClick={() => {
              onDuplicate();
            ...
            className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2 text-sm text-foreground hover:bg-foreground/[0.04] transition-all duration-200 cursor-pointer"
          >
          ...
          <button
            ...
            className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2 text-sm text-destructive hover:bg-destructive/10 transition-all duration-200 cursor-pointer"
          >
