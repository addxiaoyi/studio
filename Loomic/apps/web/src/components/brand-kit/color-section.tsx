          ...
          <div key={color.id} className="flex flex-col items-center gap-1.5">
            <div className="relative group" ref={editingAsset?.id === color.id ? editAnchorRef : undefined}>
              <button
                ...
                className="w-[69px] h-[69px] rounded-xl border border-border/40 cursor-pointer transition-all duration-300 hover:scale-[1.04] hover:shadow-md focus-visible:ring-2 focus-visible:ring-foreground/20"
              ...
              <button
                ...
                className={cn(
                  ...
                  "opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-all duration-300 cursor-pointer",
                )}
        ...
        <div className="flex flex-col items-center gap-1.5">
          <div className="relative">
            <button
              ...
              className="w-[69px] h-[69px] rounded-xl border-2 border-dashed border-muted-foreground/30 flex items-center justify-center hover:border-foreground/30 hover:bg-foreground/[0.02] transition-all duration-300 cursor-pointer focus-visible:ring-2 focus-visible:ring-foreground/20"
