  ...
  return (
    <section>
      ...
      <textarea
        ...
        rows={3}
        className="w-full resize-none rounded-xl border bg-transparent px-3 py-2.5 text-sm outline-none placeholder:text-muted-foreground/60 focus:border-muted-foreground/60 transition-all duration-300"
      />
    </section>
  );
}
