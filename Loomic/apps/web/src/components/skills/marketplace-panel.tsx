...
import type { MarketplaceDetail, MarketplaceSkill } from "@helstera/shared";
...
function MarketplaceSkillCard({
  ...
  return (
    <motion.div
      ...
      className="group cursor-pointer rounded-2xl border border-border/40 glass-soft p-4 transition-all duration-300 hover:glass hover:border-border/60"
    >
      {/* Header */}
      <div className="mb-2 flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          <div className="flex size-7 shrink-0 items-center justify-center rounded-lg glass-soft">
    ...
    <div>
      ...
      <div className="relative mb-4 sm:mb-6 sm:max-w-md">
        ...
        <input
          ...
          aria-label="搜索市场技能"
          className="h-10 w-full rounded-lg border border-input bg-transparent pl-8 pr-3 text-sm outline-none transition-all duration-300 placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 sm:h-8"
        />
        {loading && (
