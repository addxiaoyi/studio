  ...
  return (
    <div className="max-w-lg">
      ...
      <motion.div
        ...
        className="rounded-2xl border border-border/40 glass p-6"
      >
        {/* Header */}
        <div className="mb-5 flex items-center gap-3">
          <div className="flex size-9 items-center justify-center rounded-lg glass-soft">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              aria-label="技能 URL"
              className={cn(
                "h-8 w-full rounded-lg border bg-transparent pl-8 pr-3 text-sm outline-none transition-all duration-300 placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:opacity-50",
                isError
        ...
        {isSuccess && (
          <motion.div
            ...
            className="mt-4 flex items-center justify-between rounded-2xl border border-border/30 glass-soft px-4 py-3"
          >
