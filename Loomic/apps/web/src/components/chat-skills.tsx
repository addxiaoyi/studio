      ...
      <div className="flex max-w-sm flex-wrap justify-center gap-2">
        {PRESET_SKILLS.map((skill) => (
          <button
            ...
            className="inline-flex h-9 max-w-full items-center justify-center gap-1.5 rounded-full glass-soft border border-border/40 px-3.5 text-sm text-foreground transition-all duration-300 hover:glass hover:border-foreground/20"
          >
            <span className="shrink-0 text-muted-foreground/70">{skill.icon}</span>
