...
function TierToastItem({
  ...
  return (
    <motion.div
      ...
      className="relative w-[380px] overflow-hidden rounded-2xl glass-strong border border-border/40 shadow-card-hover"
    >
      <div className="p-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={onDismiss}
                className="ml-2 flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-muted-foreground transition-all duration-300 hover:bg-foreground/[0.04] hover:text-foreground"
              >
            ...
            <div className="mt-3 flex items-center gap-2">
              <button
                ...
                className={`rounded-lg px-3 py-1.5 text-xs font-medium text-primary-foreground transition-all duration-300 hover:opacity-90 ${config.progressColor}`}
              >
                {config.cta}
              </button>
              <button
                type="button"
                onClick={onDismiss}
                className="rounded-lg px-3 py-1.5 text-xs text-muted-foreground transition-all duration-300 hover:text-foreground"
              >
                {"\u5173\u95ED"}
              </button>
            </div>
