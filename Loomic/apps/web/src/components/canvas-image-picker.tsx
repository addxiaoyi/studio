...
export function MessageMentionPicker({
  ...
  if (filteredItems.length === 0) {
    return (
      <div
        ref={containerRef}
        className="absolute bottom-full left-2 mb-2 w-56 rounded-2xl glass-strong border border-border/40 p-3 shadow-card-hover"
      >
  ...
  return (
    <div
      ref={containerRef}
      className="absolute bottom-full left-2 mb-2 max-h-64 w-64 overflow-y-auto rounded-2xl glass-strong border border-border/40 shadow-card-hover"
    >
      <div className="p-2">
        {(
          [
            ...
            <div key={kind} className="mb-2 last:mb-0">
              ...
              {sectionItems.map((item) => (
                <button
                  ...
                  className="flex w-full items-center gap-2.5 rounded-lg px-2 py-1.5 text-left transition-all duration-300 duration-200 hover:bg-foreground/[0.04] focus-visible:ring-2 focus-visible:ring-foreground/20 focus-visible:outline-none"
                >
