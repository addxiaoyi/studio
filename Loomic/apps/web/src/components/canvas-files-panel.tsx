...
const FileRow = memo(function FileRow({
  ...
  return (
    <div
      className="group flex items-center gap-3 rounded-lg px-2 py-1 hover:bg-foreground/[0.04] transition-all duration-300"
    ...
    >
      ...
      <button
        ...
        className="flex h-4 w-4 shrink-0 items-center justify-center text-foreground hover:text-muted-foreground transition-all duration-300"
        title="下载"
  ...
  return (
    ...
    >
      ...
      <div className="flex h-[50px] shrink-0 items-center justify-between px-4">
        ...
        <button
          type="button"
          className="flex h-7 w-7 items-center justify-center rounded-lg text-muted-foreground hover:bg-foreground/[0.04] hover:text-foreground transition-all duration-300"
          onClick={onClose}
