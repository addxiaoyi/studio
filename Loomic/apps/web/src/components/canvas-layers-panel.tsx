...
const LayerRow = memo(function LayerRow({
  ...
  return (
    <div style={{ contentVisibility: "auto", containIntrinsicSize: "auto 44px" }}>
      <button
        type="button"
        className={`group/layer flex h-11 w-full items-center gap-2.5 rounded-lg px-2 text-left transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 ${
          selected
            ? "bg-muted"
...
export function CanvasLayersPanel({
  ...
  return (
    <div
      ref={panelRef}
      className="fixed left-0 top-0 z-30 flex h-full w-[280px] flex-col border-r border-border/60 glass-strong animate-in slide-in-from-left duration-200"
    ...
    >
      ...
      <div className="flex h-11 shrink-0 items-center justify-between px-3">
        ...
        <button
          type="button"
          className="flex h-6 w-6 items-center justify-center rounded-md text-muted-foreground hover:bg-foreground/[0.04] hover:text-foreground transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
          onClick={onClose}
