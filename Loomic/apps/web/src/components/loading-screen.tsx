...
/**
 * Helstera Loading Screen
 * Glass modal with breathing logo
 */
export function LoadingScreen() {
  return (
    ...
    >
      <div className="glass-strong rounded-3xl p-8 animate-logo-float">
        <svg
          viewBox="0 0 100 100"
          fill="none"
        ...
        >
          <path
            ...
            fill="currentColor"
          />
          <g className="animate-star-sparkle" style={{ transformOrigin: "35.5px 50.5px" }}>
            <path
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          <span className="size-1 rounded-full bg-foreground/30 animate-loading-dot [animation-delay:0ms]" />
          <span className="size-1 rounded-full bg-foreground/30 animate-loading-dot [animation-delay:160ms]" />
          <span className="size-1 rounded-full bg-foreground/30 animate-loading-dot [animation-delay:320ms]" />
        </div>
      </div>
    </div>
  );
