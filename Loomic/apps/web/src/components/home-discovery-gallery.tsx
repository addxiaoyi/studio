        ...
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              点击卡片后会直接按这条案例思路新建 Helstera 项目，并进入 agent 对话流。
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {visibleCases.map((item) => (
          <button
            ...
            className="group overflow-hidden rounded-2xl border border-border/60 glass-soft transition-all duration-300 hover:-translate-y-1 hover:glass"
          >
            <div className="relative aspect-[4/5] overflow-hidden glass-soft">
              <img
