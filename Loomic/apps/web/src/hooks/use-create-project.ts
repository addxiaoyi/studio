...
export const INITIAL_ATTACHMENTS_KEY = "helstera:initial-attachments";
export const INITIAL_IMAGE_GENERATION_PREFERENCE_KEY =
  "helstera:initial-image-generation-preference";
export const INITIAL_VIDEO_GENERATION_PREFERENCE_KEY =
  "helstera:initial-video-generation-preference";
export const INITIAL_AGENT_MODEL_KEY = "helstera:initial-agent-model";
