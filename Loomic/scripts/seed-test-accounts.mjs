#!/usr/bin/env node
/**
 * Seed test accounts for Helstera deployment.
 *
...
const TEST_ACCOUNTS = [
  { email: "free@test.helstera.com",    plan: "free",    credits: 50    },
  { email: "starter@test.helstera.com", plan: "starter", credits: 1_200 },
  { email: "pro@test.helstera.com",     plan: "pro",     credits: 5_000 },
  { email: "ultra@test.helstera.com",   plan: "ultra",   credits: 15_000 },
];

const PASSWORD = "Helstera-Test-2026";
